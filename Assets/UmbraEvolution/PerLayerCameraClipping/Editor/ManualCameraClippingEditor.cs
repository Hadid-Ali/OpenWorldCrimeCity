...
namespace UmbraEvolution
{
    ...
    public class PerLayerCullingEditor : Editor
    {
        public override void OnInspectorGUI()
        {
            ...
            ManualCameraClipping cullingScript = (ManualCameraClipping)target; //specifies the script to to be affected

            //Keeps the inspector organized by providing layer names
            for (int index = 0; index < ManualCameraClipping.NUMBER_OF_UNITY_LAYERS; index++)
            {
