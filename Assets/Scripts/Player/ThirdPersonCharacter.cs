...
namespace UnityStandardAssets.Characters.ThirdPerson
{
	...
	public class ThirdPersonCharacter : MonoBehaviour
	{
        ...
        [SerializeField] float aimSpeedNormalize = 4f;
		...
		void Start()
		{
            if (this.GetComponent<CharacterController>())
                this.characterController = this.GetComponent<PlayerController>();
        ...
        public bool IsAimingPlayer
        {
            get
            {
                if (!this.characterController)
                    return false;
                return this.characterController.aimingManager.IsAiming;
            }
        }
		...
		void UpdateAnimator(Vector3 move)
		{
            ...
            m_Animator.SetFloat("Forward", this.IsAimingPlayer ? this.rv.magnitude > 0 ? 0.5f : 0f : m_ForwardAmount, 0.1f, Time.deltaTime);
